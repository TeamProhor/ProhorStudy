...
export function IconMenu(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" {...props}>
      <rect x="1" y="3.5" width="13" height="1.1" rx="0.55" fill="currentColor" />
      <rect x="1" y="7.2" width="13" height="1.1" rx="0.55" fill="currentColor" />
      <rect x="1" y="10.9" width="13" height="1.1" rx="0.55" fill="currentColor" />
    </svg>
  );
}
...
export function IconChats(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function IconIncognito(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="17" height="17" viewBox="0 0 21.2 21.2" fill="currentColor" {...props}>
...
export function IconCode(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="14" height="14" fill="currentColor" viewBox="0 0 256 256" {...props}>
...
export function IconVoice(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="19" height="19" viewBox="0 0 21.2 21.2" fill="currentColor" {...props}>
...
export function IconSend(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" {...props}>
      <path d="M7.5 12V3M3.5 7l4-4 4 4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
